...
| File | What it is |
|---|---|
| `countersign-rfp-studio.html` | The entire app. Rename to `index.html` if you like. |
...
| `countersign-data.json` | Optional "directory file" — a exported workspace the app auto-loads. You create this from inside the app. |

## Quick start (no server code at all)

1. Upload `countersign-rfp-studio.html` to any web root, e.g. `public_html/rfp/index.html`.
